...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tagent信息表';
...
) ENGINE = InnoDB AUTO_INCREMENT = 2232459 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tagent ip表（多网卡）';
...
CREATE TABLE IF NOT EXISTS `tagent_os`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_name`(`name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1015788851806208 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tagent os';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tagent cpu架构表';
...
CREATE TABLE IF NOT EXISTS `tagent_upgrade_audit`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1031296594591744 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tagent升级';
...
CREATE TABLE IF NOT EXISTS `tagent_upgrade_detail`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1031296594591745 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tagent升级';
...
CREATE TABLE IF NOT EXISTS `tagent_version`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tagent版本';